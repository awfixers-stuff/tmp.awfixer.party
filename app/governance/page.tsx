...
export const metadata: Metadata = {
  ...
  description: "How the AWFixer Party governs itself — transparency, accountability, and member democracy.",
}
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-12 px-4 pb-16 sm:gap-14 sm:px-6 sm:pb-20">
        <header className="space-y-3">
          ...
          <p className="text-muted-foreground italic">
            "We do not ask of others what we do not first demand of ourselves."
          </p>
        </header>
