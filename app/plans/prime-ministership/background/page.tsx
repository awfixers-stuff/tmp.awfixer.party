...
export const metadata: Metadata = {
  title: "Background | Prime Ministership Plan | AWFixer Political Party",
  description: "AWFixer Political Party prime ministership background.",
}

export default function PrimeMinistershipBackgroundPage() {
  return (
    <div className="flex">
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-12 px-4 pb-16 sm:gap-14 sm:px-6 sm:pb-20">
        <header className="space-y-3">
          ...
          <h1 className="font-heading text-2xl font-semibold tracking-tight sm:text-3xl">
            Prime Ministership - Background
          </h1>
          <p className="text-lg text-muted-foreground">
            Background on the Prime Ministership.
          </p>
        </header>
