...
export const metadata: Metadata = {
  title: "Socials | AWFixer Political Party",
  description: "Connect with the AWFixer Political Party on social media and Discord.",
}
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-12 px-4 pb-16 sm:gap-14 sm:px-6 sm:pb-20">
        <header className="space-y-3">
          ...
          <p className="text-muted-foreground italic">
            Stay informed, get involved, and join the conversation.
          </p>
        </header>
