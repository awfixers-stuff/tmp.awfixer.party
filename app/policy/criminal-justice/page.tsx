...
import { CriminalJusticeContent } from "./criminal-justice-content"
import { TableOfContents } from "./toc"

export const metadata: Metadata = {
  title: "Criminal Justice | AWFixer Political Party",
  description: "AWFixer Party criminal justice and prison reform policy.",
}
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-12 px-4 pb-16 sm:gap-14 sm:px-6 sm:pb-20">
        <header className="space-y-3">
          ...
          <p className="text-lg text-muted-foreground">
            Real consequences, real rehabilitation
          </p>
        </header>
