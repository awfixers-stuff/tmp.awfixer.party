...
import { bylaws, type NavItem } from "@/lib/nav"
...
export function BylawsDropdown({
  isOpen,
  setIsOpen,
  isActive,
  dropdownRef,
...
interface BylawsDropdownMobileProps {
  isOpen: boolean
  setIsOpen: (open: boolean) => void
  isActive: boolean
}

export function BylawsDropdownMobile({
  isOpen,
  setIsOpen,
  isActive,
}: BylawsDropdownMobileProps) {
  const pathname = usePathname()
