        ...
        >
          ...
          <div className="hidden items-center sm:flex">
            ...
            <div ref={dropdownRef} className="relative">
              ...
              >
                Policy
                <ChevronDown className={cn("ml-1 h-3 w-3 transition-transform duration-200", policyOpen && "rotate-180")} />
              </Button>
              <div
                className={cn(
                      ...
                      {section.items.map((item) => (
                        <Link
                          ...
                          className={cn(
                            ...
                            pathname === item.href ? "bg-accent text-foreground" : "text-foreground/70"
                          )}
                        >
                          {item.label}
                        </Link>
            ...
            {/* Group 3: Events, Plans, Gladiator */}
            <div className="flex items-center gap-1">
              <div ref={eventsDropdownRef} className="relative">
                ...
                >
                  Events
                  <ChevronDown className={cn("ml-1 h-3 w-3 transition-transform duration-200", eventsOpen && "rotate-180")} />
                </Button>
                <div
                  className={cn(
                  ...
                  <div className="flex flex-col p-2">
                    ...
                    {upcomingEventsMeta.map((event) => (
                      <Link
                        ...
                        className={cn(
                          "block rounded-xl px-3 py-2 text-sm font-medium transition-colors",
                          "hover:bg-accent hover:text-foreground focus:bg-accent focus:text-foreground",
                          pathname === `/events/${event.slug}` ? "bg-accent text-foreground" : "text-foreground/70"
                        )}
                      >
                        {event.title}
                      </Link>
                    ...
                    <Link
                      ...
                      className={cn(
                        "block rounded-xl px-3 py-2 text-sm font-medium transition-colors",
                        "hover:bg-accent hover:text-foreground focus:bg-accent focus:text-foreground",
                        pathname === "/events" ? "bg-accent text-foreground" : "text-purple-600"
                      )}
                    >
                      View All Events
                    </Link>
              ...
              <div ref={plansDropdownRef} className="relative">
                ...
                >
                  Plans
                  <ChevronDown className={cn("ml-1 h-3 w-3 transition-transform duration-200", plansOpen && "rotate-180")} />
                </Button>
                <div
                  className={cn(
                  ...
                  <div className="flex flex-col p-2">
                    ...
                    {plansMeta.map((plan) => (
                      <Link
                        ...
                        className={cn(
                          "block rounded-xl px-3 py-2 text-sm font-medium transition-colors",
                          "hover:bg-accent hover:text-foreground focus:bg-accent focus:text-foreground",
                          pathname === `/plans/${plan.slug}` ? "bg-accent text-foreground" : "text-foreground/70"
                        )}
                      >
                        {plan.title}
                      </Link>
                    ...
                    <Link
                      ...
                      className={cn(
                        "block rounded-xl px-3 py-2 text-sm font-medium transition-colors",
                        "hover:bg-accent hover:text-foreground focus:bg-accent focus:text-foreground",
                        pathname === "/plans" ? "bg-accent text-foreground" : "text-purple-600"
                      )}
                    >
                      All Plans
                    </Link>
              ...
              <Button
                ...
                asChild
              >
                <Link href="/gladiator" aria-current={isGladiatorPage ? "page" : undefined}>
                  Gladiator
                </Link>
              </Button>
            </div>
            ...
            <Button size="sm" className="rounded-full" asChild>
              <a href="https://mee6.gg/awfixerpolitics" target="_blank" rel="noopener noreferrer">
                Discord
              </a>
            </Button>
          </div>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-3">
          ...
          <div className="mb-2">
            ...
            >
              <span>Policy</span>
              <ChevronDown className={cn("h-4 w-4 transition-transform duration-200", policyOpen && "rotate-180")} />
            </button>
            <div
              className={cn(
          ...
          <div className="mb-2">
            ...
            >
              <span>Events</span>
              <ChevronDown className={cn("h-4 w-4 transition-transform duration-200", eventsOpen && "rotate-180")} />
            </button>
            <div
              className={cn(
                "overflow-hidden transition-all duration-200",
          ...
          <div className="mb-2">
            ...
            >
              <span>Plans</span>
              <ChevronDown className={cn("h-4 w-4 transition-transform duration-200", plansOpen && "rotate-180")} />
            </button>
            <div
              className={cn(
                "overflow-hidden transition-all duration-200",
